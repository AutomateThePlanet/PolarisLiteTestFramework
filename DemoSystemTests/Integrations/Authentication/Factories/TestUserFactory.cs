...
namespace DemoSystemTests.Integrations.Authentication.Factories;
public static class TestUserFactory
{
    ...
    {
        return IntegrationSettings.TwilioSettings.PhoneNumber.Replace("+", "");
    }
    ...
    private static async Task<TestUser> CreateTestUserAsync(string username, string email, string password, string phone, string status)
    {
        ...
        var response = await ApiClient.PostAsync<TestUser>(request);
