...
public class MobileDevices
{
    ...
    public const string GalaxyS5 = "Samsung Galaxy S5";
    public const string GalaxyS9Plus = "Galaxy S9+";
    public const string GalaxyS20Ultra = "Samsung Galaxy S20 Ultra";
    public const string GalaxyNote3 = "Samsung Galaxy Note 3";
