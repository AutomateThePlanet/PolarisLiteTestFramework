...
using OpenQA.Selenium.DevTools.V126.Security;
...
public partial class DriverAdapter : IDevToolsService
{
    ...
    public void StartNetworkTrafficMonitoring()
    {
        ...
        INetwork networkInterceptor = _webDriver.Manage().Network;
    ...
    public void AddExtraHttpHeader(string header)
    {
        ...
        settings.Headers.Add("Accept-Encoding", header);
        DevToolsSession.SendCommand(settings);
    }
    ...
    public void AssertResponse404ErrorCodeReceivedByPartialUrl(string partialUrl) => throw new NotImplementedException();
}
